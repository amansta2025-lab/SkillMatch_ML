...
DATASET_PATH = PROJECT_DIR / "dataset" / "reordered_raw.csv"

OUTPUT_FOLDER = (
    PROJECT_DIR
    / "output"
    / "Linear_Regression_with_Metrics_M2"
)
...
print("=" * 60)
print("LINEAR REGRESSION - SKILLMATCH")
print("=" * 60)
...
# Features used to predict MonthlyIncome
feature_columns = [
    "Age",
    "JobLevel",
    "TotalWorkingYears",
...
plt.title(
    "SkillMatch - Linear Regression: Actual vs Predicted Monthly Income"
)
...
plt.title(
    "SkillMatch - Residual Plot - Linear Regression"
)
...
plt.title(
    "SkillMatch - Linear Regression Feature Coefficients"
)
...
with open(
    ...
    file.write(
        "SkillMatch Linear Regression Equation\n"
    )

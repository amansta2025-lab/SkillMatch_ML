# ================================================================
# DECISION TREE CLASSIFIER - EMPLOYEE ATTRITION PREDICTION
...
# Identifier columns do not provide meaningful predictive
# information and can cause unnecessary tree splits.
...
# class_weight="balanced" helps when Attrition classes
# are imbalanced.
...
plt.title(
    "Decision Tree - Attrition Confusion Matrix"
)
...
plt.title(
    "Decision Tree Performance - Employee Attrition"
)
...
print(
    ...
    "        DECISION TREE ATTRITION PREDICTION COMPLETED"

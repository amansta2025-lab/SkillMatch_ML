...
# SKILL MATCH / EMPLOYEE ATTRITION PREDICTION
# USING RAW DATASET
# ================================================================
#
# IMPORTANT:
...
DATASET_PATH = (
    r"C:/Users/AMAN/Documents/Skill_Match/dataset/reordered_raw.csv"
)
...
print(
    "             RANDOM FOREST SKILL MATCH PREDICTION"
)
...
# ================================================================
# 17. REMOVE CONSTANT / NON-INFORMATIVE COLUMNS
# ================================================================
#
# These columns contain no useful variation or are identifiers:
#
# EmployeeCount
# EmployeeNumber
# Over18
...
# ================================================================
# 24. CREATE RANDOM FOREST CLASSIFIER
# ================================================================
...
plt.title(
    ...
    "Random Forest - Skill Match Confusion Matrix"
...
plt.title(
    ...
    "Random Forest Skill Match Performance"
...
plt.title(
    ...
    "Top 15 Random Forest Feature Importances - Skill Match"
...
# ================================================================
# 45. RANDOM FOREST TREE VISUALIZATION
# ================================================================
#
...
plt.title(
    ...
    "Random Forest - Skill Match - Tree 1",
...
model_path = os.path.join(
    ...
    "random_forest_skill_match_model.pkl"
...
# ================================================================
# 48. SAVE RANDOM FOREST PARAMETERS
# ================================================================
...
print(
    "          RANDOM FOREST SKILL MATCH COMPLETED SUCCESSFULLY"
)
